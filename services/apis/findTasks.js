...
//取得任務詳情 (Get task details)
export const getTasksDetail = (taskId) =>
  req("GET", `/find-task/detail/${taskId}`);

//我要接案
export const postApplyTask = (taskId) =>
  req("POST", `/find-task/apply/${taskId}`, {}, { auth: true });
