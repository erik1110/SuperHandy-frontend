  ...
  <v-sheet border="sm" opacity-12 class="text-body-2 mx-auto pa-3">
    <v-form @submit.prevent="submit" ref="profileForm">
      <div class="text-end">
        ...
        >
        <div v-else>
          <v-btn type="submit" class="me-2" :loading="loading" color="error"
            >更新</v-btn
          >
          <v-btn
            type="button"
      ...
      <v-container fluid="">
        <v-row>
          <v-col cols="12" md="6">
            ...
            <v-text-field
              :rules="profileFormRules.name.rule"
              v-model="user.lastName"
              :disabled="isDisabled"
              :counter="profileFormRules.name.counter"
              :hint="profileFormRules.name.hint"
              required
            />
          </v-col>
          <v-col cols="12" md="6">
        ...
        <v-row>
          <v-col>
            ...
            <v-text-field
              :rules="profileFormRules.nickname.rule"
              v-model="user.nickname"
              :disabled="isDisabled"
              :counter="profileFormRules.nickname.counter"
              :hint="profileFormRules.nickname.hint"
              required
            />
          </v-col>
        </v-row>
        ...
        <v-row>
          <v-col>
            ...
            <v-text-field
              :rules="profileFormRules.address.rule"
              v-model="user.address"
              :disabled="isDisabled"
              :counter="profileFormRules.address.counter"
              :hint="profileFormRules.address.hint"
              required
            />
          </v-col>
        </v-row>
        <v-row>
          <v-col>
            <label class="label text-grey-darken-2" for="posterIntro"
              >案主簡介</label
            >
            <v-textarea
              :rules="profileFormRules.intro.rule"
              v-model="user.posterIntro"
              :disabled="isDisabled"
              :counter="profileFormRules.intro.counter"
              :hint="profileFormRules.intro.hint"
            />
          </v-col>
        </v-row>
        <v-row>
          <v-col>
            <label class="label text-grey-darken-2" for="helperIntro"
              >幫手簡介</label
            >
            <v-textarea
              :rules="profileFormRules.intro.rule"
              v-model="user.helperIntro"
              :disabled="isDisabled"
              :counter="profileFormRules.intro.counter"
              :hint="profileFormRules.intro.hint"
            />
        ...
        <v-row>
          <v-col>
            ...
            <v-select
              :rules="profileFormRules.helperSkills.rule"
              :disabled="isDisabled"
